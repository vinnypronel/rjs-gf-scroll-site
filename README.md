#  Birthday Website for a Friend's Girlfriend

An interactive, animated birthday website with smooth scrolling, parallax effects, and heartfelt messages. (Tailored specifically for mobile device access)
...
3. **Video**: Letterbox bars expand for cinematic effect
4. **Footer**: Pulsing red heart & Signature 
...
A heartfelt message appears in the middle section with a typewriter word reveal animation.
